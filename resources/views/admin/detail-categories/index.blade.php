...
@section('content')
    <div class="container">
        ...
        <h2 class="text-center font-title"><strong>Administra las categorías de productos desde acá</strong>
        </h2>

        <hr class="hr-servicios">

        <button type="button" data-bs-toggle="modal" data-bs-target="#add-detail-category-modal"
    ...
    <center>
        ...
        @endif
        @include('admin.detail-categories.add')
                    ...
                    <tbody>
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td class="align-middle">
                                    <center>
                                        <button type="button" data-bs-toggle="modal"
                                            data-bs-target="#edit-detail-category-modal{{ $category->id }}"
                                            class="btn bg-gradient-safewor-black text-white"
                                            style="text-decoration: none;">Editar</button>

                                        <form method="post" action="{{ url('/det-cat/delete/' . $category->id) }}"
                                ...
                                @include('admin.detail-categories.edit')
                            </tr>
                        @endforeach
                    </tbody>
                </table>
