<div class="modal fade" id="edit-exercise-modal{{ $exercise->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="{{ url('exercises/update/' . $exercise->id) }}" method="post"
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="input-group input-group-static">
                            ...
                            <select id="general_category_id" name="general_category_id"
                                ...
                                <option selected value="{{ $exercise->gen_category_id }}">
                                    {{ $exercise->gen_category }}
                    ...
                    <div class="col-md-12 mb-3">
                        <div
                            ...
                            <input value="{{ isset($exercise->exercise) ? $exercise->exercise : '' }}" type="text"
                                class="form-control form-control-lg @error('exercise') is-invalid @enderror"
